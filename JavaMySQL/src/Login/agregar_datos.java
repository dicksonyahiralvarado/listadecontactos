 ...
 */
public class agregar_datos extends javax.swing.JFrame {

    /**
     * Creates new form agregar_datos
     */
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        lista_contactos ventana = new lista_contactos();
        ventana.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton2ActionPerformed

    private void Agregar() {
        String alumno = Alumno.getText();
        String nombre = Apellido.getText();
        String  apellido = Email.getText();
        String email = Nombre.getText();
        String telefono = Telefono.getText();
        
            try {
               
                Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/isunah_prog2","root","2022yahir");//Establishing connection
                ...
                JOptionPane.showMessageDialog(null, "Contacto ingresado con exito");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(agregar_datos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new agregar_datos().setVisible(true);
            }
        });
    }
